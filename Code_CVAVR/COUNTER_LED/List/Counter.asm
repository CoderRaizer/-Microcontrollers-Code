...
; 0000 0026 // Func7=Out Func6=Out Func5=Out Func4=Out Func3=Out Func2=Out Func1=Out Func0=Out
; 0000 0027 // State7=0 State6=0 State5=0 State4=0 State3=0 State2=0 State1=0 State0=0
...
; 0000 0091         dv = i%10;
	...
	MOVW R10,R30
; 0000 0092 
; 0000 0093         PORTC = led7[t];
	MOVW R30,R6
	RCALL SUBOPT_0x0
; 0000 0094         PORTA = 0x02;
	LDI  R30,LOW(2)
	RCALL SUBOPT_0x1
; 0000 0095         delay_ms(2);
; 0000 0096         PORTC = 0xff;//tat led
; 0000 0097 
; 0000 0098         PORTC = led7[c];
	MOVW R30,R8
	RCALL SUBOPT_0x0
; 0000 0099         PORTA = 0x04;
	LDI  R30,LOW(4)
	RCALL SUBOPT_0x1
; 0000 009A         delay_ms(2);
; 0000 009B         PORTC = 0xff;//tat led
; 0000 009C 
; 0000 009D         PORTC = led7[dv];
	MOVW R30,R10
	RCALL SUBOPT_0x0
; 0000 009E         PORTA = 0x08;
	LDI  R30,LOW(8)
	RCALL SUBOPT_0x1
; 0000 009F         delay_ms(2);
; 0000 00A0         PORTC = 0xff;//tat led
; 0000 00A1 
; 0000 00A2         PORTC = led7[j];
	MOVW R30,R12
	RCALL SUBOPT_0x0
; 0000 00A3         PORTA = 0x01;
	LDI  R30,LOW(1)
	OUT  0x1B,R30
